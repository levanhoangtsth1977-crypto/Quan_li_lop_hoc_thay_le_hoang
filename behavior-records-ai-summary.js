...
(function(){
  ...
  function renderTable(kind){
    ...
    const body=p.querySelector(kind==='violation'?'#violationTableBody':'#rewardTableBody');if(!body)return;
  ...
  function renderAI(){
    ...
    const v=getRecords('violation'),k=getRecords('reward');
