 ...
 * Danh mục chuẩn hóa cho form Vi phạm/Khen thưởng.
 * Giữ mã value nội bộ khi có thể để không làm hỏng bản ghi cũ.
...
(function(){
  ...
  const VIOLATIONS = [
    ...
    ['late-submission','Quên nộp bài hoặc nộp bài chưa đúng yêu cầu'],
    ...
    ['safety-games','Chơi các trò nguy hiểm, gây mất an toàn'],
    ['other','Khác']
  ];
