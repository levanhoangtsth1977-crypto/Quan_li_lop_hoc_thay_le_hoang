...
function loadFinal(){if(document.querySelector('script[data-lh-authoritative-game]'))return;var s=document.createElement('script');s.src='curriculum-authoritative-final.js?v=3.1.0&fresh='+Date.now();s.async=false;s.setAttribute('data-lh-authoritative-game','1');document.head.appendChild(s)}
