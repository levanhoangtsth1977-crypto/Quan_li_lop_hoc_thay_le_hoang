/* TRIỆU PHÚ HỌC ĐƯỜNG — QUESTION BANK SYSTEM 3.4 */
(function(){'use strict';
...
function subject(v){var s=norm(v);if(['TOAN','MATH','MATHEMATICS'].indexOf(s)>=0)return'math';if(['TV','TIENGVIET','VIETNAMESE'].indexOf(s)>=0)return'vietnamese';if(['KH','KHOAHOC','SCIENCE'].indexOf(s)>=0)return'science';if(['LSDL','LSDIALI','LICHSUDIALI','LICHSUVADIALI','LICHSUVAĐIALI','HISTORY','HISTORYGEOGRAPHY','HISTORYANDGEOGRAPHY'].indexOf(s)>=0)return'history';return s.toLowerCase();}
