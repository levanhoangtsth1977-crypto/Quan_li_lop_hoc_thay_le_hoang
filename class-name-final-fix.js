/* CLASS NAME FINAL FIX 2.0 — display normalization only. Canonical class: 5A3. */
(function(){
  'use strict';
  if(window.__LH_CLASS_NAME_FINAL_20__)return;
  window.__LH_CLASS_NAME_FINAL_20__=true;
  var NAME='Lớp 5A3';
  ...
  function boot(){[0,100,300,800,1500,3000].forEach(function(ms){setTimeout(fix,ms)});}
