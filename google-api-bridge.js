...
async function init(){
  await loadScript('./event-delete-all-ui.js?v=MASTER-FINAL-20260826');
  ...
  // Bắt buộc nạp module tạo link riêng; module này tự lắng nghe
  // google-sheets-data-ready nên có thể khởi tạo lại chính xác sau khi dữ liệu về.
  await loadScript('./student-links-fix.js?v=3.0.1');
  load();
}
