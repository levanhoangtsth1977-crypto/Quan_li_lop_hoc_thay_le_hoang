/* MENU RUNTIME FIX 8.55 — iframe POST behavior save */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_855__)return;
  window.__MENU_RUNTIME_FIX_855__=true;
  ...
  function boot(){
    ...
    loadOnce('behavior-save-hardfix-21.js?v=20260914.24','data-lh-behavior-save-hardfix-v24-disabled');
    loadOnce('behavior-save-canonical-24.js?v=20260914.25','data-lh-behavior-save-canonical-v25-disabled');
    loadOnce('behavior-save-canonical-26.js?v=20260914.26','data-lh-behavior-save-canonical-v26');
