/* MENU RUNTIME FIX 8.16 — lean runtime
...
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_816__) return;
  window.__MENU_RUNTIME_FIX_816__=true;
  ...
  function boot(){
    ...
    /* Canonical SMAS loader: same 2.0 module already present in index.html is not loaded twice. */
