/* MENU RUNTIME FIX 8.47 — canonical behavior save/picker chain */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_847__)return;
  window.__MENU_RUNTIME_FIX_847__=true;
  ...
  function boot(){
    ...
    loadOnce('behavior-save-hardfix.js?v=20260914.8','data-lh-behavior-save-hardfix-v18');
