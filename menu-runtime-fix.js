/* MENU RUNTIME 8.59 — single canonical Master CRUD path */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_859__)return;
  window.__MENU_RUNTIME_FIX_859__=true;
  ...
  function boot(){
    ...
    loadOnce('master-crud-ui.js?v=20260915.3','data-lh-master-crud-ui-v3');
