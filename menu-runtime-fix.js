/* MENU RUNTIME 8.58 — single canonical Master CRUD path */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_858__)return;
  window.__MENU_RUNTIME_FIX_858__=true;
  ...
  function boot(){
    ...
    loadOnce('master-crud-ui.js?v=20260915.2','data-lh-master-crud-ui-v2');
