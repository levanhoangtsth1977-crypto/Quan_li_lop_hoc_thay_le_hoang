/* MENU RUNTIME FIX 8.38 — lean + idempotent runtime
   ...
   Violation quick-pick catalog is loaded once and reinforced after opening the form.
*/
(function(){
'use strict';
if(window.__MENU_RUNTIME_FIX_838__)return;
window.__MENU_RUNTIME_FIX_838__=true;
...
loadOnce('clear-current-violations-once.js?v=20260912.1','data-lh-clear-current-violations-once-v20');
...
/* Violation quick-pick catalog 2.2: reinforces after form creation/open. */
loadOnce('behavior-quick-options.js?v=2.2.0','data-lh-violation-quick-options-v22');
