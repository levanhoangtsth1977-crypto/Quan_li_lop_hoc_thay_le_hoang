/* MENU RUNTIME 8.57 — single canonical Master CRUD path */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_857__)return;
  window.__MENU_RUNTIME_FIX_857__=true;
  ...
  function boot(){
    ...
    loadOnce('master-crud-ui.js?v=20260915.1','data-lh-master-crud-ui-v1');
