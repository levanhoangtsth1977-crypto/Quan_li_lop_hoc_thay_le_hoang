/* MENU RUNTIME FIX 8.53 — canonical behavior save/picker chain */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_853__)return;
  window.__MENU_RUNTIME_FIX_853__=true;
  ...
  function boot(){
    ...
    loadOnce('behavior-save-canonical-24.js?v=20260914.24','data-lh-behavior-save-canonical-v24');
