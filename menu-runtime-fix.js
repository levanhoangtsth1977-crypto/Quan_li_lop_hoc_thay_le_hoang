/* MENU RUNTIME FIX 8.37 — lean + idempotent runtime
   ...
   Violation quick-pick catalog is loaded once and only targets violationType.
*/
(function(){
'use strict';
if(window.__MENU_RUNTIME_FIX_837__)return;
window.__MENU_RUNTIME_FIX_837__=true;
...
/* Violation catalog only. Khen thưởng catalog is intentionally untouched here. */
loadOnce('behavior-quick-options.js?v=2.1.0','data-lh-violation-quick-options-v21');
