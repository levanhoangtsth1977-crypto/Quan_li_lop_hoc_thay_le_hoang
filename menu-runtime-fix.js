/* MENU RUNTIME FIX 8.38 — safe menu rescue + isolated form/link fixes */
(function(){
  'use strict';
  ...
  function boot(){
    ...
    loadOnce('events-save-jsonp-v2.js?v=20260913.3','data-lh-events-save-jsonp-v23');
    ...
    loadOnce('behavior-save-hardfix.js?v=20260914.1','data-lh-behavior-save-hardfix-v10');
