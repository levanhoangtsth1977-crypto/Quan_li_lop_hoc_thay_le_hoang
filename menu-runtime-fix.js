...
function install(){
 ...
 /* Bắt buộc nạp bản Bridge/Dedupe mới, tránh browser giữ bản ?v= cũ. */
 setTimeout(()=>{loadFresh('student-sync-dedupe.js','student-dedupe-210');loadFresh('google-api-bridge.js','google-bridge-630')},150);
 if(typeof window.loadGoogleSheetsMenuData==='function')setTimeout(()=>window.loadGoogleSheetsMenuData(),1200);
}
