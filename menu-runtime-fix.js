/* MENU RUNTIME FIX 8.54 — canonical behavior save/picker chain */
(function(){
  'use strict';
  if(window.__MENU_RUNTIME_FIX_854__)return;
  window.__MENU_RUNTIME_FIX_854__=true;
  ...
  function boot(){
    ...
    loadOnce('behavior-save-canonical-24.js?v=20260914.25','data-lh-behavior-save-canonical-v25');
